      ...
      {isOpen && (
        <div className="p-4 bg-slate-50 dark:bg-slate-700/50 text-sm space-y-2">
          <div className="flex justify-between">
            <span className="text-slate-500">تكلفة الموظفين:</span>
            <span>
              {costData.employeeCost.toLocaleString(undefined, {
          ...
          <div className="flex justify-between">
            <span className="text-slate-500">تكلفة المستقلين:</span>
            <span>
              {costData.freelancerCost.toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}{" "}
              {currency}
            </span>
          ...
          <div className="flex justify-between">
            <span className="text-slate-500">تكلفة المصروفات:</span>
            <span>
              {costData.expenseCost.toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}{" "}
              {currency}
            </span>
          ...
          <div className="flex justify-between">
            <span className="text-slate-500">تكلفة الساعات الإضافية:</span>
            <span>
              {costData.overtimeCost.toLocaleString(undefined, {
                maximumFractionDigits: 2,
              })}{" "}
              {currency}
            </span>
