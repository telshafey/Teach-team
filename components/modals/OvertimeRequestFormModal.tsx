                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" step="0.5" id="requestedHours" value={formData.requestedHours} onChange={e => setFormData({ ...formData, requestedHours: Number(e.target.value) })} className="w-full p-2 border border-slate-300 dark:border-slate-600 rounded-md text-sm" required />
                            </div>
                        </div>
                        <div>
