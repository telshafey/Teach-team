      ...
      <div className="flex-1 flex flex-col h-full">
        {upcomingMeetings.length > 0 ? (
            ...
            {upcomingMeetings.map((meeting) => (
              ...
              >
                <div>
                  ...
                  {meeting.startTime && (
                    <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">
                      {format(parseISO(meeting.startTime), "d MMM, hh:mm a", {
                        locale: arSA,
                      })}
                    </p>
                  )}
                ...
                <button
                  ...
                  className="text-xs font-semibold text-green-600 dark:text-green-400 hover:underline px-2 py-1 bg-green-50 dark:bg-green-900/30 rounded-md"
                >
                  انضمام
                </button>
              </div>
          ...
          <EmptyState
            ...
            message="لا توجد اجتماعات قادمة مجدولة."
          />
        )}
      </div>
    </Card>
