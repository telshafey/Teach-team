...
export const UsersIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M15 19.128a9.38 9.38 0 002.625.372 9.337 9.337 0 004.121-.952 4.125 4.125 0 00-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 018.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0111.964-4.663M12 12a4.125 4.125 0 100-8.25 4.125 4.125 0 000 8.25z"
    />
  </svg>
);
...
export const ChatBubbleLeftEllipsisIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 01-2.53-.388m-5.122-3.322c-.422-.22-.85-.463-1.25-.742a9.92 9.92 0 01-3.476-6.422C2.186 6.862 3.166 4.986 4.63 3.753c1.465-1.233 3.42-1.875 5.37-1.875 4.97 0 9 3.694 9 8.25z"
    />
  </svg>
);
...
export const DocumentArrowDownIcon: React.FC<IconProps> = ({
  className = "w-6 h-6",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
...
export const SparklesIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.898 20.562L16.25 21.75l-.648-1.188a2.25 2.25 0 01-1.423-1.423L13.25 18.5l1.188-.648a2.25 2.25 0 011.423-1.423L16.25 15.25l.648 1.188a2.25 2.25 0 011.423 1.423L19.25 18.5l-1.188.648a2.25 2.25 0 01-1.423 1.423z"
    />
  </svg>
);
...
export const CurrencyDollarIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 6v12m-3-2.818l.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182.95-.715 2.162-.878 3.242-.397"
    />
  </svg>
);
...
export const Cog8ToothIcon: React.FC<IconProps> = ({
  className = "w-6 h-6",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.594 3.94c.09-.542.56-.94 1.11-.94h2.593c.55 0 1.02.398 1.11.94l.213 1.281c.063.374.26.716.53.992l.89.89c.432.432.432 1.131 0 1.563l-.89.89a1.5 1.5 0 01-.53.992l-.213 1.281c-.09.543-.56.941-1.11.941h-2.593c-.55 0-1.02-.398-1.11-.941l-.213-1.281a1.5 1.5 0 01-.53-.992l-.89-.89a1.125 1.125 0 010-1.563l.89-.89a1.5 1.5 0 01.53-.992l.213-1.281zM15 12a3 3 0 11-6 0 3 3 0 016 0z"
    />
  </svg>
);
...
export const WrenchScrewdriverIcon: React.FC<IconProps> = ({
  className = "w-6 h-6",
}) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M11.42 15.17L17.25 21A2.652 2.652 0 0021 17.25l-5.878-5.878m-5.878 5.878l-2.296-2.297a2.652 2.652 0 010-3.75l5.878-5.878m-5.878 5.878l-5.878-5.878a2.652 2.652 0 013.75-3.75l5.878 5.878m-3.75 0h.008v.008h-.008v-.008z"
    />
  </svg>
);
...
export const ArrowPathIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0011.664 0l3.181-3.183m-11.664 0l4.992-4.993m-4.993 0l-3.181 3.183a8.25 8.25 0 000 11.664l3.181 3.183"
    />
  </svg>
);
...
export const BriefcaseIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M20.25 14.15v4.075c0 1.313-.964 2.411-2.175 2.585-1.211.174-2.427-.24-3.32-1.135l-1.635-1.635-1.635 1.635c-.9.9-2.11.13-3.32 1.135-1.21.174-2.175-1.272-2.175-2.585v-4.075a2.25 2.25 0 0 1 2.25-2.25h10.5a2.25 2.25 0 0 1 2.25 2.25Z"
    />
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9.75 4.875c0-.593.237-1.157.659-1.579.422-.422.986-.659 1.579-.659h1.513c.593 0 1.157.237 1.579.659.422.422.659.986.659 1.579v4.075c0 .593-.237 1.157-.659 1.579-.422-.422-.986.659-1.579.659H11.99c-.593 0-1.157-.237-1.579-.659-.422-.422-.659.986-.659-1.579V4.875Z"
    />
  </svg>
);
...
export const CalendarDaysIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M12 12.75h.008v.008H12v-.008Zm-3.002 0h.008v.008H9v-.008Zm6.002 0h.008v.008h-.008v-.008Zm-3.002 3h.008v.008H9v-.008Zm3 0h.008v.008h-.008v-.008Zm3 0h.008v.008h-.008v-.008Zm-6 0h.008v.008H9v-.008Z"
    />
  </svg>
);
...
export const ArrowTrendingUpIcon: React.FC<IconProps> = ({
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 18 9 11.25l4.306 4.307a11.95 11.95 0 0 1 5.814-5.519l2.74-1.22m0 0-3.75-.625m3.75.625V3.375"
    />
  </svg>
);
...
export const TicketIcon: React.FC<IconProps> = ({ className = "w-6 h-6" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M16.5 6v.75m0 3v.75m0 3v.75m0 3V18m-9-12v.75m0 3v.75m0 3v.75m0 3V18m-3 .75h18A2.25 2.25 0 0021 16.5V7.5A2.25 2.25 0 0018.75 5.25H3A2.25 2.25 0 00.75 7.5v9A2.25 2.25 0 003 18.75z"
    />
  </svg>
);
