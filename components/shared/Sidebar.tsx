...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    },
    {
      ...
      permission:
        hasPermission("view_reports") && siteSettings?.isReportsModuleEnabled,
    },
    {
      id: "finance",
      label: "المالية",
      ...
      >
        <div className="h-full px-3 pb-4 overflow-y-auto flex flex-col">
          ...
          <div className="flex-shrink-0">
            <div
              className="flex items-center space-x-3 rtl:space-x-reverse p-2 cursor-pointer rounded-lg hover:bg-slate-100 dark:hover:bg-slate-700"
            ...
            <button
              ...
              className="w-full flex items-center p-2 mt-2 text-base font-normal text-slate-900 rounded-lg hover:bg-slate-100 dark:text-white dark:hover:bg-slate-700"
            >
