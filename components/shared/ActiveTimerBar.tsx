...
export const ActiveTimerBar: React.FC = () => {
    ...
    return (
        <div className="bg-green-600 dark:bg-green-700 text-white flex items-center justify-between px-4 py-2 text-sm font-medium animate-pulse-slow">
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
                <ClockIcon className="w-5 h-5" />
                <span className="font-semibold">المهمة النشطة:</span>
                <span className="truncate max-w-xs">{activeTimer.taskTitle}</span>
            </div>
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
