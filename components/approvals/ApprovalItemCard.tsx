    ...
    return (
        <div className="p-3 bg-slate-50 dark:bg-slate-700/50 rounded-md flex justify-between items-center">
            <div>
                ...
                <p className="text-xs text-slate-500 dark:text-slate-400 mt-1">{details}</p>
            </div>
            <button onClick={() => onReview(item)} className="text-sm font-semibold text-sky-600 hover:text-sky-800">
                مراجعة
            </button>
        </div>
    );
