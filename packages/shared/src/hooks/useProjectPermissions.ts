  ...
  const permissions = useMemo(() => {
    ...
    const defaultPermissions = {
      canEditProjectSettings:
        canGloballyManageProjects || hasGlobalPermission("edit_projects"),
      canManageTasks:
        canGloballyManageProjects ||
        hasGlobalPermission("create_tasks") ||
        hasGlobalPermission("edit_tasks") ||
        hasGlobalPermission("delete_tasks"),
    ...
    const projectMemberInfo = project.members.find(
